...
class StatusSerializer(serializers.HyperlinkedModelSerializer):
    # users = serializers.PrimaryKeyRelatedField(many=True, read_only=False)
...
class UserSerializer(serializers.HyperlinkedModelSerializer):
    ...
    # status = serializers.HyperlinkedRelatedField(many=False, view_name='status-detail', read_only=True)
    class Meta:
        model = User
